<main>
    ...
    <div class="row background-div">
      ...
      <div class="col-md-6 d-flex justify-content-center align-items-center">
        <form wire:submit.prevent="login" method="POST" class="p-3 rounded shadow bg-white small-form">
            <h2 class="mb-3 text-center text-primary">Welcome, Please Login....</h2>

            
            <div class="mb-3 row">
                <label for="username" class="col-form-label col-md-2">Username</label>
                <div class="col-md-8">
                <input type="email" wire:model="email" class="form-control" id="username" placeholder="Enter your username">
  ...
  background-image: linear-gradient(#191970, green);
    ...
    .top-left-image {
      background: url('assets/img/circle-removebg-preview.png') no-repeat; /* Small image */
      ...
      z-index: 2; /* Ensure this image is above the gradient */
    }
    ...
    .welcome-text {
      position: relative;
      z-index: 2; /* Ensure this text appears above other elements */
    }
